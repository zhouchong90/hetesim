...
public class XmlHeteSim {
	 ...
	 */
	private Document readXml(String filePath)	throws MalformedURLException,DocumentException
	{
	 ...
	 * @throws DocumentException
	 */
	public ArrayList<String> getRelations(String filePath) throws MalformedURLException, DocumentException
	{
...
//					System.out.println(el.getText());
	 ...
	 * @throws DocumentException
	 */
	public ArrayList<String> getEntities(String filePath) throws MalformedURLException, DocumentException
	{
	 ...
	 * @return
	 */
	public String getAbbrName(char abbr,String filePath) throws MalformedURLException, DocumentException
	{
	...
	{
		XmlHeteSim heteSim = new XmlHeteSim();
		ArrayList<String> list = new ArrayList<String>();
		heteSim.createXml("C:/HeteSim/AuthorDataConf.xml");
